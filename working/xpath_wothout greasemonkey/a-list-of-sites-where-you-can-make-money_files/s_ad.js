...
return _47;
},dcfp_name:function(d){
var m=d.id.match(/_hub_([0-9a-z_]+)_\d+X\d+/);
if(m){
return m[1];
}
return null;
...
var _89=4;
while(div){
if(div.nodeType==1&&div.id&&((div.id.indexOf("boonity_")==0)||(boonity.dcfp_name(div)))){
...
var url=ele.src;
return boonity.is_adsense(url)||boonity.is_ypn(url)||boonity.is_pub_center(url)||boonity.is_chitika(ele)||boonity.is_pulse(url)||boonity.is_dcfp(ele);
...
var _a9="__boon_test_cookie__";
document.cookie=_a9;
var _aa=(document.cookie.indexOf(_a9)!=-1);
document.cookie=_a9+"=a; expires=Fri, 27 Jul 2001 02:47:11 UTC";
return _aa;
},rand_int:function(){
