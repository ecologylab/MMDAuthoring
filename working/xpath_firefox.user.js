...
// @description   In-browser Meta Metadata Authoring Tool. Developed by Gaurav Aggarwal (gaurav@logiclord.com) during GSOC 2011 with EcologyLab A&M Texas University
// @include       *
	...
	$("#activate").click( function () {
		...
		$('#Generate_button').click( function() {
	       ...
	       //rootMMD = {};
	        ...
	        // show results in windows box.
			$(".mmdMessage").text( JSON.stringify(tempResult) );
